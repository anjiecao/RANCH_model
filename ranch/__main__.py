"""Command line for the pipeline:  python -m ranch <stage> [options]
  ...
  score-adults  --which main|selfcons|selfcons_ext|lesion    (the adult table suffix)
...
PREDS = {"main": "adult_preds_main.csv", "adult_base": "adult_preds_selfcons.csv", "adult_ext": "adult_preds_selfcons_ext.csv",
         "lesion_adults": "adult_preds_lesion.csv"}
ADULT_KIND = {"main": "main", "selfcons": "adult_base", "selfcons_ext": "adult_ext", "lesion": "lesion_adults"}
